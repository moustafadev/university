...
--Вызов ранее измененной процедуры
DECLARE @prod int, @result int,@ID_book int
EXEC @result = add_book 122, 'bookss', '2020', 32, 3 , @ID_book OUTPUT IF (@result = 0)
SELECT @ID_book as book_IDDDD
ELSE
SELECT 'Error during insert' as error
